...
namespace LaRottaO.CSharp.DataGridViewUtilities
{
    public class ShowMultipleObjectsAsRows
    {
        ...
        public async Task<DataTable> show(List<object> argObjectList, Boolean argShowDebug = true)
        {
            try
            {
            ...
            {
                MessageBox.Show("There was a problem while trying to show multiple objects as DataTable rows: " + ex.StackTrace, "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop);
